...
var questions = [	{question:SQUARE_ROOT+"64",answer:8},
					{question:SQUARE_ROOT+"81",answer:9},
					{question:SQUARE_ROOT+"25",answer:5},
					{question:"9"+EXPONENT_2,answer:81},
					{question:SQUARE_ROOT+"16",answer:4},
					{question:SQUARE_ROOT+"9",answer:3},
					{question:SQUARE_ROOT+"49",answer:7},
					{question:"10"+EXPONENT_2,answer:100},
					{question:"2"+EXPONENT_2,answer:4},
					{question:"6"+EXPONENT_2,answer:36},
					{question:"11"+EXPONENT_2,answer:121},
					{question:SQUARE_ROOT+"36",answer:6},
					{question:"5"+EXPONENT_2,answer:25},
					{question:SQUARE_ROOT+"4",answer:2}
				 ];
...
function setupPlanes() {
	...
	for (var i = 0; i < questions.length; i++) {
		...
		landingPlanes.push({
			...
			label: new createjs.Text(questions[i].question, "20px Lato", "#000000")
		});
